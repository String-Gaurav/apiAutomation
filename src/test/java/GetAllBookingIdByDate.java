...
public class GetAllBookingIdByDate extends BaseTest {


    @Test(description = "To fetch the details of the booking IDs based on dates")
    public void getAllBookingByDate() {
        String checkIn = "2017-01-17";
        test.log(LogStatus.INFO, "Starting the test to get booking details");
        /*
         * Send a GET request to /booking?checkin{date}
         * and check that the response has HTTP status code 200
         */
        //Sending the GET request for a specific booking id and receiving the response

        test.log(LogStatus.INFO, "Getting the response by giving the request as date");
