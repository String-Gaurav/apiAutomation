...
public class UpdateBooking extends BaseTest {
    ...
    public void updateBooking() {
        ...
        bookingDetails.setFirstname("Saurabh");
        bookingDetails.setLastname("Singh");

        String cookieValue = "token=" + newAuthToken;

        //Sending the PUT request
        test.log(LogStatus.INFO, "Sending the PUT request to update the booking detail of booking id : " + IDtoUpdate);
